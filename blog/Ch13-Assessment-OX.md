<iframe src="https://namkicheol.github.io/englisheducation/assessment.html" width="100%" height="1000px" style="border: none; border-radius: 10px;"></iframe>

# [영어교육론] Ch.13 Assessment OX 20문항 — 해설 완전 정복

Ch.13 Assessment OX는 용어 자체보다 **조건 판별**이 핵심입니다. 비용·시간·운영이면 Practicality, score consistency면 Reliability, intended construct와 task 대응이면 Validity, feedback이 수업과 학습을 바꾸면 Washback입니다.
...
맞습니다. <span style="color:#3182ce">**Practicality**</span>는 assessment가 reasonable amount of time and resources 안에서 create and administer될 수 있는지를 봅니다.
...
<span style="color:#dd6b20">**답안 패턴**</span>: The assessment has low practicality because it requires too much time/resources to administer in the given classroom context.
...
틀립니다. Practicality는 "좋은 평가인가"를 포괄적으로 묻는 말이 아니라 **운영 가능성**을 묻는 quality입니다.

<span style="color:#c53030">**함정**</span>: "수업 목표와 잘 맞는다"는 Validity 쪽 단서이고, "채점이 일관적이다"는 Reliability 쪽 단서입니다. Practicality 답안에는 financial limitation, time constraint, ease of administration 중 하나가 살아 있어야 합니다.
...
맞습니다. <span style="color:#3182ce">**Reliability**</span>는 test가 consistent and dependable results를 주는 정도입니다.
...
<span style="color:#c53030">**2014 기입10 / 2025 A-1**</span> 출제 영역
...
<span style="color:#dd6b20">**한 줄 정리**</span>: Reliability는 "일관되게 재는가", Validity는 "제대로 재는가"입니다.
...
맞습니다. <span style="color:#3182ce">**Validity**</span>는 test가 측정하려는 것을 실제로 측정하는 정도입니다.
...
<span style="color:#c53030">**2011 Q24 / 2017 기입8 / 2026 A-8**</span> 출제 영역
...
<span style="color:#c53030">**함정**</span>: "학생들이 test를 그럴듯하다고 느낀다"는 face validity이고, 그것만으로 content validity나 construct validity를 증명할 수 없습니다.
...
맞습니다. <span style="color:#3182ce">**Authenticity**</span>는 test task가 target language use task와 대응하는 정도이고, <span style="color:#3182ce">**Interactiveness**</span>는 learner의 individual characteristics가 task 수행에 관여하는 정도입니다.
...
<span style="color:#c53030">**2012 Q25 / 2018 기입8 / 2025 A-9**</span> 출제 영역
...
<span style="color:#dd6b20">**답안 패턴**</span>: The task has high authenticity because it resembles target language use; it has high interactiveness because it engages learners' language knowledge, topical knowledge, and affective schemata.
...
맞습니다. <span style="color:#3182ce">**Washback effect**</span>는 testing이 teaching과 learning에 미치는 영향입니다.
...
<span style="color:#c53030">**2014 기입10 / 2017 기입8 / 2018 기입7 / 2022 A-1**</span> 출제 영역
...
<span style="color:#c53030">**함정**</span>: Feedback이 존재한다는 말만으로 충분하지 않습니다. 그 feedback이 learner에게 diagnostic information을 주는지까지 써야 합니다.
...
맞습니다. <span style="color:#3182ce">**Test Types**</span>는 label이 아니라 purpose, score interpretation, task performance 기준으로 구분합니다.
...
<span style="color:#c53030">**2010 Q25 / 2011 Q29 / 2014 기입11**</span> 출제 영역
...
<span style="color:#c53030">**2010 Q26 / 2015 기입8**</span> 출제 영역
...
맞습니다. <span style="color:#3182ce">**Alternative Assessment**</span>는 learner의 actual performance, process, reflection, teacher judgement를 중시하는 흐름으로 이해하면 됩니다.

<span style="color:#3182ce">**Performance-based assessment**</span>는 productive and observable skills를 직접 수행하게 하고, meaningful, engaging, authentic tasks에서 process와 product를 함께 볼 수 있습니다. <span style="color:#3182ce">**Portfolio**</span>는 learner work의 purposeful collection으로 efforts, progress, achievements를 보여 줍니다.

<span style="color:#c53030">**2010 Q29 / 2016 서술6 / 2018 서술6**</span> 출제 영역
...
<span style="color:#c53030">**함정**</span>: Portfolio를 "결과물 파일철"로만 쓰면 부족합니다. efforts, progress, achievements, responsibility, autonomy까지 연결해야 합니다.
...
맞습니다. <span style="color:#3182ce">**Holistic scoring**</span>은 composition as a whole에 대해 single score를 주고, <span style="color:#3182ce">**Analytic scoring**</span>은 components를 따로 rating합니다.
...
<span style="color:#c53030">**2021 논술2 / 2024 기입6**</span> 출제 영역
...
<span style="color:#c53030">**2023 B-11**</span> 출제 영역
...
<span style="color:#c53030">**2023 A-1**</span> 출제 영역
...
<span style="color:#c53030">**2012 Q23 / 2015 서술2 / 2018 서술2 / 2025 A-1**</span> 출제 영역
...
<span style="color:#c53030">**2026 A-8**</span> 출제 영역
...
<span style="color:#dd6b20">**마무리 패턴**</span>: 시험장에서 OX를 서술형으로 바꾸면, 항상 "term + evidence + effect" 순서로 씁니다. 예: The task has high authenticity because its topic and discourse purpose resemble real-world communication.
